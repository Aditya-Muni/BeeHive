...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  return (
    <main className="">
      ...
      <div className="flex justify-center items-center mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24">
        <div className="lg:col-start-2 self-center bg-gray-100 p-10 rounded-lg">
          ...
          <div className="mt-16 text-sm font-medium">
            ...
            <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
              ...
              <div className="flex justify-between">
                <p>Transaction Fee</p>
                <p className="text-gray-900">{formatPrice(49)}</p>
              </div>

              <div className="flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900">
                <p className="text-base">Total</p>
                <p className="text-base">{formatPrice(orderTotal + 49)}</p>
              </div>
            </div>
